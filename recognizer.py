...
from config import NUMPOINTS, SQUARESIZE, ORIGIN
import math
import numpy as np
...
class Recgonizer:
    ...
    def __init__(self, templates, shouldConvert):
        if shouldConvert:
            ...
            for template in templates:
                ...
                unistrokedTemp = {"name": unistroked.name, "points": unistroked.points}
    ...
    def recognize(self, points):
        ...
        if u == -1:
            ...
            return self.templates[u]["name"], str(round((t1-t0) * 1000, 3))
